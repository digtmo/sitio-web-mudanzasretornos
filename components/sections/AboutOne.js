            ...
            <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2">
              <div className="inner-column">
                <div className="sec-title">
                  ...
                  <div className="text">Nuestros servicios son convenientes. Los clientes destacan la competencia de nuestros trabajadores y la calidad de la mudanza que prestamos. En Econotrans destacamos por nuestra atención personalizada a cada cliente.</div>
                </div>
                <div className="content-box">
                  <div className="about-block">
                    <i className="icon flaticon-worldwide-shipping" />
                    <h4 className="title"> Mudanzas Normales </h4>
                    <p className="text">Servicio de mudanzas estándar para hogares y residencias.</p>
                  </div>
                  <div className="about-block">
                    <i className="icon flaticon-3d-cube" />
                    <h4 className="title"> Mudanzas Empresas u Oficinas </h4>
                    <p className="text">Servicio especializado en mudanzas de empresas y oficinas.</p>
                  </div>
                  <div className="about-block">
                    <i className="icon flaticon-3d-cube" />
                    <h4 className="title"> Fletes y Transportes de Carga </h4>
                    <p className="text">Transporte de carga y mercancías de forma segura y eficiente.</p>
                  </div>
                  <div className="about-block">
                    <i className="icon flaticon-3d-cube" />
                    <h4 className="title"> Servicios de Embalaje y Encomiendas </h4>
                    <p className="text">Servicio de embalaje y envío de paquetería.</p>
                  </div>
                </div>
